 ...
 */
public class DefaultNoise implements Filter {
	
	protected float factorOne;
	protected float factorTwo;
	protected float factorThree;
	protected float factorFour;
	protected Color color;
	
	public DefaultNoise(float factorOne, float factorTwo, float factorThree, float factorFour, Color color) {
	...
	public static DefaultNoise getDefaultNoiseTypeOne(Color color){
		
		return new DefaultNoise(.1f, .1f, .25f, .25f, color);
	}
	
	public static DefaultNoise getDefaultNoiseTypeTwo(Color color){
		
		return new DefaultNoise(.1f, .25f, .5f, .9f, color);
	}
}
