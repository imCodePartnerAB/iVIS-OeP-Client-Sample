...
@Table(name = "ivis_radio_button_query_alternatives")
@XMLElement
public class RadioButtonAlternative extends GeneratedElementable implements MutableFieldAlternative, Serializable {
