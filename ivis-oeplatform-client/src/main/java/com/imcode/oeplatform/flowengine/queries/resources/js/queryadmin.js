...
function addIvisAlternative(alternativesSelector, imagePath, size, moveTitle, deleteTitle) {
	...
	html += '<input type="checkbox" id="exported_' + uuid + '" value="' + uuid + '" name="exported_' + uuid + '" class="vertical-align-center">';
	html += '<input type="text" id="xsdElementName_' + uuid + '" name="xsdElementName_' + uuid + '" style="width: 20%;">';
	html += '<input type="text" id="alternative_' + uuid + '" name="alternative_' + uuid + '" style="width: 69%;">';
