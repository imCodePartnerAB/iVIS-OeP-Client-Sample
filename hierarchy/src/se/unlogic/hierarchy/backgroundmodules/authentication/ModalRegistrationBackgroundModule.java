...
public class ModalRegistrationBackgroundModule extends AnnotatedBackgroundModule {
	...
	protected String registrationModuleURI;
	...
	public BackgroundModuleResponse processBackgroundRequest(HttpServletRequest req, User user, URIParser uriParser) throws Exception {
		...
		XMLUtils.appendNewElement(doc, document, "registrationModuleURI", this.registrationModuleURI);
