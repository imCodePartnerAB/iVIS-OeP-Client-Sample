...
|---------------------------------------------------|
|                                                   |
| Updated by Robert "Unlogic" Olofsson              |
|                                                   |
|--------------------------------------------------*/

// Node object
function Node(id, pid, name, url, title, target, icon, iconOpen, open, customHtml) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.add = function(id, pid, name, url, title, target, icon, iconOpen, open, customHtml) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, target, icon, iconOpen, open, customHtml);
};
