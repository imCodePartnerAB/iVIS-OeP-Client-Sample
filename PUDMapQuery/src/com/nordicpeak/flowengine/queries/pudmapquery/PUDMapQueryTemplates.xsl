			...
			<xsl:if test="/Document/previewMode = 'WEB_MAP'">
				...
				<script type="text/javascript">
					...
					$(document).ready(function(){
						initPUDMapQuery('<xsl:value-of select="PUDMapQueryInstance/PUDMapQuery/queryID" />', '<xsl:value-of select="/Document/requestinfo/contextpath" /><xsl:value-of select="/Document/fullAlias" />', '<xsl:value-of select="/Document/startExtent" />', '<xsl:value-of select="/Document/lmUser" />', true);
					});
	...
	<xsl:template match="ShowQueryForm">
		...
		<div class="query" id="{$queryID}">
			...
			<script type="text/javascript">
				...
				$(document).ready(function(){
					initPUDMapQuery('<xsl:value-of select="PUDMapQueryInstance/PUDMapQuery/queryID" />', '<xsl:value-of select="/Document/requestinfo/contextpath" /><xsl:value-of select="/Document/fullAlias" />', '<xsl:value-of select="/Document/startExtent" />', '<xsl:value-of select="/Document/lmUser" />', false);
				});
