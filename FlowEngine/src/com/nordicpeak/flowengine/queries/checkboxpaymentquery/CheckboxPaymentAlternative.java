...
@Table(name = "checkbox_payment_query_alternatives")
@XMLElement
public class CheckboxPaymentAlternative extends GeneratedElementable implements MutableAlternative, Serializable {
	...
	public CheckboxPaymentAlternative() {

	}

	public CheckboxPaymentAlternative(String name) {
	...
	public boolean equals(Object obj) {
		...
		CheckboxPaymentAlternative other = (CheckboxPaymentAlternative) obj;
