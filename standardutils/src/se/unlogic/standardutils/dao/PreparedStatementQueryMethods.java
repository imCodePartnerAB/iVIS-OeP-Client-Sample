	...
	static{
		try {
			...
			for(Method method : methods){
				...
				if(method.getName().startsWith("set") && !method.getName().equals("setObject") && !method.getName().equals("setNull") && method.getParameterTypes().length == 2 && method.getParameterTypes()[0] == int.class){
