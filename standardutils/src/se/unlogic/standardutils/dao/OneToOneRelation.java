...
public interface OneToOneRelation<LocalType, RemoteType> {

	public abstract void getRemoteValue(LocalType bean, Connection connection, RelationQuery relations) throws SQLException;
	...
	public abstract boolean preAdd();
}
